...
The most important file is =queueing_book.pdf=, which contains the text and exercises (which I use for inspiration for the exams) with hints and solutions, for my course on queueing theory.
