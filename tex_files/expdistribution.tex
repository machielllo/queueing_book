...
\begin{exercise}\label{ex:30}
 Assume \marginpar{In this and the next exercises we show that exponential $\implies$ Poisson.} that inter-arrival times $\{X_i\}$ are iid\ $\sim\Exp(\lambda)$. Let
