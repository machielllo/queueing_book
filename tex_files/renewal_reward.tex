...
\newthought{With the renewal reward theorem} we can relate limiting fraction of time the server is busy to the utilization $\rho=\lambda \E S$.
In fact, for the $G/G/1$ queue,
\begin{equation}\label{eq:49}
 \lim_{t\to\infty} \frac 1 t \int_0^t \1{\L(s)>0} \d s = \lambda \E S =  \rho.
\end{equation}
...
\end{equation*}
By taking appropriate limits\sidenote{\cref{ex:70}}
\begin{equation}\label{eq:86}
\lambda \E S \geq \rho \geq \delta \E S.
\end{equation}
Rate-stability, i.e., $\delta=\lambda$, then completes the argument.
