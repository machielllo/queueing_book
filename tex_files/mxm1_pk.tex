...
&=  \E\L \E S = \E{\W}.
\end{align*}
Hence, $\E{\W^B}$ is equal to  the average time $\E W$ an item spends in queue.\sidenote{As it should.}
...
\begin{equation}\label{eq:17}
  \E{\Ls^B} = \lambda \frac{\E{B^2}}2\E S + \frac\rho 2 = \frac{1+C_s^2}2 \frac{\rho}{1-\rho} \E B + \frac{\rho}{2},
\end{equation}
