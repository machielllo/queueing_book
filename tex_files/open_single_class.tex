...
\begin{equation*}
p(n) =  \P{N_1=n_1, \ldots, N_M=n_M}  = \Pi_{i=1}^M p(n_i). % = \Pi_{i=1}^M (1-\rho_i)\rho_i^{n_i},
\end{equation*}
...
Let $p(i,j)=\P{N_1=i, N_2=j}$ be the probability that station $1$ contains $i$ jobs and station $2$ contains $j$ jobs.
