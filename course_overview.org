...
9. <2021-04-10 za> If you need to use Sakasegawa's formula, you should assume that the results are exact, rather than approximate.
10. <2021-04-10 za> You should provide your answer in the same unit of time as given in the problem.
11. <2021-04-10 za> Rouding to 3 significant digits is sufficient.
11. You will not be penalized for small deviations in precision from the
    expected answer. Specifically, suppose your answer is $x$ and ours
    (the correct) is $y$. Whenever $x/y \in [0.95, 1.05]$ we accept your
    answer as correct.
12. The exam is personalized: you have your own set of questions (in a
    ...
    Nestor.
13. You are not allowed to distribute the exam until 1 hour after the
...
14. After 1 hour after the closing time of the exam on Nestor, you are
    of course allowed to share and discuss your exam.
15. You provide your answers on Nestor in the directory 'Course
...
16. We are available during the exam for questions. You can mail us your
