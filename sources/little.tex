...
\end{equation}
acquires the interpretation of the total time jobs spent in the system up to time~$t$.\sidenote{Or, the total amount paid by the jobs up to time $t$.}
