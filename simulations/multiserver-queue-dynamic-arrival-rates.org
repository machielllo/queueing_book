...
\begin{exercise}
Change the service time distribution for another distribution (take any distribution to your liking.). Analyze the impact on the KPIs.
\end{exercise}
...
\begin{exercise}
Explain line 4. Hint, compare the code of multi server we discussed earlier. 
\end{exercise}
