#+title: Queueing theory assignments: simulations
#+SUBTITLE: EBB074A05
...
* Assignment 5: Queueing with blocking

We simulate queues with blocking rules on waiting time or queue length. We also develop algorithms to compute the state probabilities.

- ~queues-with-blocking.pdf~
- ~queues-with-blocking.org~


* TODO Assignment 6: Simulation with event stacks
