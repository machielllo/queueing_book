...
If you copy paste the code below into your own python environment or in the browser (on the above sites), the code should run more or less as is. 
...
Here I show how to set up  environment in python to simulate queueing systems in discrete time. The youtube videos in which I provide the explanation are her:
