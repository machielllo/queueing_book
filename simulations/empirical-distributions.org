...
* General info
This file contains the code and the results that  go with these youtube movie https://youtu.be/aKfv908uWqM
...
#+begin_src python :results file :var fname="emp0.png"
...
*** DONE Explain: the =plt.clf()= is necessary to clear earlier plots.
...
*** TODO Why is the numerical performance so bad? 
...
#+begin_src python :results file :var fname="emp1.png"
x = [2, 5, 2, 1, 8, 5, 5, 5]
x, F = cdf_better(x)
...
#+begin_src python :results file :var fname="emp2.png"
plt.clf()
plt.step(x, F)
plt.savefig(fname)
fname
...
#+begin_src python :results file :var fname="emp3.png"
plt.clf()
