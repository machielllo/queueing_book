...
Quite a number of exercises in this chapter are targeted on \emph{checking} that the results for some general queueing system reduce to those for special cases.
