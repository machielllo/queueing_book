...
\end{hint}
\begin{solution}
Here are two derivations. Take whatever you like best (or both).
\begin{align*}
 \E{\sum_{i=1}^N R_i }
...
Another  derivation is based on conditional expectation. Here are the steps (where we use~\cref{ex:84}),
\begin{align*}
  \E{S_N|N=n} &= n \E R, & \E{S_N|N} &= N \E R, & \E{S_N} = \E{\E{S_N|N}} = \E N \E R.
\end{align*}
\end{solution}
\end{exercise}
